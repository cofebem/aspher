...
| A11 promotion status | **NOT yet a default** — one surface at one load (0.045% occupancy). Needs B04 (dense contact, small Ns, fallback risk) before a likely *conditional* default |
